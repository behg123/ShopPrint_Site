function cartItems() {
  ...
  if(token){
    axios
    .get("https://localhost:7150/Cart/GetByUserId/" + idUser, {
      headers: {
    ...
    .then(function (response) {
      ...
      const main = document.getElementById("cart-list");
    

      const checkoutButton = createButton("checkout-button", "Checkout", function () {
        checkoutRedirect();
      });
...
function addQuantity(idProduto) {
  ...
  axios
    .put(
      "https://localhost:7150/Cart/AddItem/",
      {
        UserId: idUser,
        ProductId: idProduto,
      },
...
function removeQuantity(idProduto) {
  ...
  axios
    .put(
      "https://localhost:7150/Cart/RemoveItem/",
      {
        UserId: idUser,
        ProductId: idProduto,
      },
...
function removeItem(idProduto) {
  ...
  axios
    .put(
      "https://localhost:7150/Cart/RemoveProduct/",
      {
        UserId: idUser,
        ProductId: idProduto,
      },
